...
class eco_move_CartPoleEnv(gym.Env[np.ndarray, Union[int, np.ndarray]]):
    """
    ## Description
    ...
    **Note:** While the ranges above denote the possible values for observation space of each element,
    ...
    def __init__(self, render_mode: Optional[str] = None):
        ...
        self.action_space = spaces.Discrete(3) # 編集
    ...
    def step(self, action):
        ...
        self.step_counter += 1 # 追加
        truncated = self.step_counter >= self.max_episode_steps # 追加

        done = terminated or truncated # 追加
